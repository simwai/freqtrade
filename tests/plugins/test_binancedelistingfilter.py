...
from freqtrade.plugins.pairlist.BinanceDelistingFilter import BinanceDelistingFilter
...
def _handler(tmp_path: Path, initial_scan: bool = True) -> BinanceDelistingFilter:
    exchange = MagicMock()
...
def test_filter_processes_announcements_and_persists_state(tmp_path, mocker):
    ...
    mocker.patch(
        "freqtrade.plugins.pairlist.BinanceDelistingFilter.requests.get",
